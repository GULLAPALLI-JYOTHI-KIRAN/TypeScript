...
let ROLE = ["admin", "user", "operator"]; // Whenever we just used as const keyword before any value it could read only cannot be changed  and you're using an array so that's whatever the values in the array will be constant
function isRole(r) {
    console.log(r);
}
